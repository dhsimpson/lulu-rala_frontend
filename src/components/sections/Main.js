  ...
  return (
    ...
    <img id="third-img-id" className="third-left" src="./section/luluRalaPlayingEnglish.jpg" alt="아이들이엔씨" />
      ...
      <div id="third-div-id" className="third-right">
        ...
        <p>균형적 언어접근법 (Balanced Language Approach)을 기반으로 듣고, 말하고, 읽고, 쓰기를 분리하지 않고 이야기와 놀이 그리고 다양한 활동으로 의사소통능력을 골고루 성장시키며 영어에 대한 자신감, 영어에 대한 호기심과 욕구를 충족시키고 성취감을 느끼도록 하며 영어를 즐겁게 습득할 수 있도록 합니다.</p>
      </div>
    </>
  );
}
  ...
  return (
    ...
    <img id="fourth-img-id" className="fourth-right" src="./section/educationalCourse.jpg" alt="아이들이엔씨" />
      ...
      <div id="fourth-div-id" className="fourth-left">
        <h2>영아 / 유아교육 과정</h2>
        <p>그림책과 다양한 교구, 노래와 챈트 율동, 게임 등으로 영어를 처음 접하는 아이들을 위한 놀이수업</p>
        <p>흥미유발과 호기심자극을 통해 재미있고 다양한 영어놀이 경험을 위한 학습</p>
        <br />
        <h2>유아 / 초등교육 과정</h2>
        <p>듣고, 말하고, 읽고 쓰는 기초적인 과정을 거쳐 주니어토플과 디베이트를 목적으로 자신의 생각을 영어로 표현하고 영어에 대한 종합적인 지식발달을 위한 학습</p>
        <br />
        <h2>기관</h2>
