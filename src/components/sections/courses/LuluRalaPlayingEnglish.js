      ...
      <section className="section-luluRalaPlayingEnglish">
        <div className="div-luluRalaPlayingEnglish">
          ...
          <div className="div-inner-luluRalaPlayingEnglish">
            ...
            균형적 언어접근법<br />
            (Balanced Language Approach)을 기반으로<br />
          ...
          균형적 언어접근법(Balanced Language Approach)을 기반으로 듣고, 말하고, 읽고, 쓰기를 분리하지 않고 이야기와 놀이 그리고 다양한 활동으로 의사소통능력을 골고루 성장시키며 영어에 대한 자신감,<br /><br />
